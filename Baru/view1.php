                ...
                <div class="container-fluid px-4">
                    ...
                    <div class="card mb-4">
                        ...
                        <div class="row">
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="form-group">
                                            <label for="nominal_pembayaran"><strong>Nominal Pembayaran</strong></label>
                                            <div class="input-group">
                                                <span class="input-group-text">Rp</span>
                                                <input type="text" id="nominal_pembayaran" class="form-control" placeholder="Masukkan jumlah uang" required>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="card mb-4">
                                    <div class="card-body">
                                        <div class="form-group">
                                            ...
                                            <div id="kembalian" class="form-control">Rp 0</div>
                                        </div>
                                    </div>
                                </div>
                            </div>
                            ...
                            <script>
                                // Fungsi untuk memberi format input sebagai mata uang rupiah saat pengguna mengetik
                                document.getElementById("nominal_pembayaran").addEventListener("input", function(event) {
                                    let input = event.target.value;
                                    input = input.replace(/[^\d.,]/g, '');
                                    let amount = parseFloat(input);
                                    if (!isNaN(amount)) {
                                        let formattedInput = formatCurrency(amount);
                                ...
                                document.getElementById("nominal_pembayaran").addEventListener("input", function(event) {
                                    ...
                                    if (!isNaN(amount)) {
                                        // Format the number with commas as thousands separators and two decimal places
                                        let formattedInput = formatCurrency(amount);
                                        event.target.value = formattedInput;
                                    }
                                });
